/* @ds-bundle: {"format":4,"namespace":"ImperialBradyDesignSystem_1c8702","components":[{"name":"Card","sourcePath":"components/content/Card.jsx"},{"name":"Tabs","sourcePath":"components/content/Tabs.jsx"},{"name":"Badge","sourcePath":"components/feedback/Badge.jsx"},{"name":"ProgressBar","sourcePath":"components/feedback/ProgressBar.jsx"},{"name":"Tag","sourcePath":"components/feedback/Tag.jsx"},{"name":"Button","sourcePath":"components/forms/Button.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Select","sourcePath":"components/forms/Select.jsx"},{"name":"AppShell","sourcePath":"ui_kits/microsite/AppShell.jsx"},{"name":"GalleryScreen","sourcePath":"ui_kits/microsite/GalleryScreen.jsx"},{"name":"HomeScreen","sourcePath":"ui_kits/microsite/HomeScreen.jsx"},{"name":"ItineraryScreen","sourcePath":"ui_kits/microsite/ItineraryScreen.jsx"}],"sourceHashes":{"assets/image-slot.js":"b1302bcecd53","components/content/Card.jsx":"41246d4f7001","components/content/Tabs.jsx":"cb0d486e9020","components/feedback/Badge.jsx":"d89ec502f858","components/feedback/ProgressBar.jsx":"7864a5ba4997","components/feedback/Tag.jsx":"622b22463396","components/forms/Button.jsx":"8a9dc2fbbc6e","components/forms/Input.jsx":"cd8f47e43c05","components/forms/Select.jsx":"af90207f807b","ui_kits/microsite/AppShell.jsx":"94c8348e5e3b","ui_kits/microsite/GalleryScreen.jsx":"f5b3a3862c10","ui_kits/microsite/HomeScreen.jsx":"b42dfcfcbbab","ui_kits/microsite/ItineraryScreen.jsx":"6a9046ce7e51","ui_kits/microsite/doc-page.js":"371bab66f42d"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.ImperialBradyDesignSystem_1c8702 = window.ImperialBradyDesignSystem_1c8702 || {});
...
function Tabs({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderBottom: item === active ? '2px solid var(--accent-primary)' : '2px solid transparent',
      marginBottom: -1
    }
  }, item)));
}
...
function Input({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      padding: '11px 14px',
      borderRadius: 'var(--radius-md)',
      border: `1px solid ${error ? 'var(--accent-secondary)' : focused ? 'var(--focus-ring)' : 'var(--border-subtle)'}`,
      outline: 'none',
      background: 'var(--surface-card)',
      color: 'var(--text-primary)',
      boxShadow: focused ? '0 0 0 3px rgba(212,102,28,0.18)' : 'none',
...
function ContactSection({ lang }) {
  ...
  }, "Danielle Guistini"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/microsite/AppShell.jsx", error: String((e && e.message) || e) }); }

// ui_kits/microsite/GalleryScreen.jsx
try { (() => {
function GalleryScreen() {
  const stops = [{
    label: 'Sights & Streets',
    title: 'royal streets,\nquiet canals.',
    tone: 'var(--color-royal-blue)'
  }, {
    label: 'Lasting Moments',
    title: 'the story we\nbring home.',
    tone: 'var(--color-chocolate)'
  }];
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    id: "gallery-hero",
    shape: "rect",
    placeholder: "Bruges canal at golden hour",
    src: "../../assets/photos/bruges-canal.jpg",
    credit: "Photo by dimitrisvetsikas1969 via Pixabay",
    style: {
      position: 'absolute',
      inset: 0
    }
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'linear-gradient(180deg,rgba(33,29,24,.05),rgba(33,29,24,.6))'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
  ...
  }, "Discovery Board"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-display)',
      fontWeight: 700,
      fontSize: 32
    }
  }, "a world waiting to be revealed."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex'
    }
  ...
  }, "London & Belgium 2027 \u2014 Discovery Board"));
}
Object.assign(__ds_scope, { GalleryScreen });
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/microsite/GalleryScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/microsite/HomeScreen.jsx
try { (() => {
// Photo strip / #journey / #discovery held back at the client's request
// (2026-08-07). Mirrors HomeScreen.jsx — restore both together.
// The president's message — opening line, body and closing quote — is set as one
// continuous block in the display face at a single size and weight, the treatment
// the client signed off on for the quote.
const PRESIDENT_MESSAGE_TYPE = {
  fontFamily: 'var(--font-display)',
  fontWeight: 400,
...
const ITINERARY_DAYS = [{
  ...
  images: [{
    ...
    src: 'photos/itinerary-london-day5-street.webp',
    altEn: 'A flower-lined shopping street in London',
    altFr: 'Une rue commerçante fleurie à Londres'
  }, {
    src: 'photos/itinerary-london-day5-big-ben.webp',
    altEn: 'Big Ben, the Palace of Westminster and Westminster Bridge beside the Thames',
    altFr: 'Big Ben, le palais de Westminster et le pont de Westminster au bord de la Tamise'
  }]
}];
...
function HomeScreen({ lang = "en" }) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'linear-gradient(180deg,rgba(12,27,58,.15) 0%,rgba(12,27,58,.75) 100%)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      left: 'clamp(24px, 10vw, 56px)',
      bottom: 'clamp(24px, 10vw, 56px)',
      right: 'clamp(24px, 10vw, 56px)',
      color: '#fff'
    }
  ...
  }, "Pinnacle 2027"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
...
// ui_kits/microsite/ItineraryScreen.jsx
try { (() => {
const DAYS = [{
  day: 'Day 1',
  place: 'London',
  desc: 'Arrival amid royal tradition and unmistakable grandeur.',
  img: 'Elizabeth Tower (Big Ben), Westminster',
  src: '../../assets/photos/london-elizabeth-tower.jpg'
}, {
  day: 'Day 2',
  place: 'London',
  desc: 'Sailing beneath Tower Bridge, opening the way east.',
  img: 'Tower Bridge from the water',
  src: '../../assets/photos/tower-bridge-dusk.jpg',
  credit: 'Photo by pierre9x6 via Pixabay'
}, {
  day: 'Day 3',
  place: 'Bruges',
  desc: 'Canal-side architecture, culture and celebrated cuisine.',
  img: 'Bruges canal house facades',
  src: '../../assets/photos/canal-houses-dusk.jpg',
  credit: 'Photo by lubovlisitsa via Pixabay'
}, {
  day: 'Day 4',
  place: 'Antwerp',
  desc: 'Distinctive flavours and intimate discoveries.',
  img: 'Antwerp Grote Markt guild houses',
  src: '../../assets/photos/antwerp-rubens-statue.jpg',
  credit: 'Photo by braico via Pixabay'
}];
function ItineraryScreen() {
  ...
  }, "The Journey"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: 'var(--font-display)',
      fontWeight: 700,
      fontSize: 36,
  ...
  }, "where one story opens into another."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32
    }
  }, /*#__PURE__*/React.createElement(Tabs, {
    items: ['London', 'Bruges', 'Antwerp'],
    active: active,
    onChange: setActive
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, DAYS.filter(d => d.place === active).map(d => /*#__PURE__*/React.createElement("div", {
    key: d.day,
    style: {
      display: 'flex',
      gap: 28,
  ...
  }, d.place), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 14,
      lineHeight: 1.6,
      color: 'var(--text-secondary)',
...
Object.assign(__ds_scope, { ItineraryScreen });
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/microsite/ItineraryScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/microsite/doc-page.js
try { (() => {
// @ds-adherence-ignore -- omelette starter scaffold (raw elements/hex/px by design)
// Copied omelette starter. Re-running copy_starter_component with this kind overwrites this file with the latest version (page content is unaffected).
/* BEGIN USAGE */
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/microsite/doc-page.js", error: String((e && e.message) || e) }); }
...
__ds_ns.GalleryScreen = __ds_scope.GalleryScreen;

__ds_ns.HomeScreen = __ds_scope.HomeScreen;

__ds_ns.ItineraryScreen = __ds_scope.ItineraryScreen;
